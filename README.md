...
- [mcpnetwork.top](https://www.mcpnetwork.top/) - An MCP server that gives any AI client 61 tools over the simulator, and PacketSmith, a terminal agent that draws the topology while it works.
